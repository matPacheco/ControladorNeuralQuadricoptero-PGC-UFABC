...
def build_model(num_neurons):
    ...
    # model.add(layers.Flatten(input_shape=(observation_space,)))  # Definir a entrada do modelo
    model.add(layers.Input((observation_space,)))  # Definir a entrada do modelo
    model.add(layers.Dense(num_neurons, input_dim=observation_space, activation='relu'))
